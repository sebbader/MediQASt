...
import org.Evaluation.NaiveEval;
 ...
 *
 */
public class RuleBasedEvalOne extends Evaluation
{

	public static void main( String[] args ) throws NumberFormatException, IOException
	{
		RuleBasedEvalOne app = new RuleBasedEvalOne(Level.INFO);
		...
		// Analyzer
		param.put("questionAnalyzer", "rulebased");
...
//		param.put("LuceneStandardMapper:BoostPerfectMatch", "false");
	...
	public RuleBasedEvalOne(Level logLevel) throws IOException {
